...
cls
color 07
title  Windows Activator by Sh4dyy
...
echo:       Created by Sh4dyy (lzbw on Discord)
...
if %_erl%==8 exit /b
if %_erl%==7 start https://pastebin.com/H0bQ18Ac & goto :MainMenu
